...
# Function to download and plot the street network with traffic analysis
def plot_traffic_analysis(network_type):
    ...
    G = ox.graph_from_place(place_name, network_type=network_type, network_speeds=True, simplify=False)
    ...
    traffic_data = traffic.Traffic.from_bbox(bbox=bbox, key=api_key)
    ...
    # Plot the network
    ox.plot_graph(G, bgcolor='w', node_size=30, node_color='#999999', edge_linewidth=0.5, edge_color='#999999')
